...
#include "WeaponMechanicComponent.generated.h"


UCLASS(Blueprintable, BlueprintType, ClassGroup=(Custom), meta=(BlueprintSpawnableComponent) )
class LAOWLSANDBOX_API UWeaponMechanicComponent : public UActorComponent
{
	/* Private Members */
