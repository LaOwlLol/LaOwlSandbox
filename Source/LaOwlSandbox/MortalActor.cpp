...
float AMortalActor::TakeDamage_Implementation(float DamageAmount, FDamageEvent const & DamageEvent, AController * EventInstigator, AActor * DamageCauser)
{
...
void AMortalActor::SetupHealthSystem()
{
...
UClass * AMortalActor::GetUsedHealthMechanicType()
{
